...
! ========================================
! v1.9.40 (2026-02-06)
!   - FEAT: PlanA-PlanB 변수 완전 통합 (UI 호환성 100%)
!   - CHANGE: 변수명 PlanA 스타일로 통일 (nLimitX_Negative 등)
!   - CHANGE: HOME 좌표 이중 변수 (HOME_GANTRY_*=내부, nHomeGantry*=UI)
!   - FEAT: RECORD 추가 (breakpoint, jointgroup, pointgroup, monRobs)
!   - FEAT: ~50개 새 PERS 변수 (bRobSwap, nRobHeight*, posStart/End 등)
!   - FEAT: CMD 상수 추가 (104, 107, 311-324, 505-507)
!   - FEAT: 40-step welddata/weavedata/trackdata 배열 (wd1~wd40, weave1~40, track0~40)
!   - FEAT: stCommand/stReact 통신 변수 (T_Head 인터페이스)
!   - FEAT: Auto/Manual 매크로 배열 (macroAutoStartA{2,10} 등)
!
! v1.9.39 (2026-02-06)

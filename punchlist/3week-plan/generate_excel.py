...
# 6개 그룹 일정 배분 (2/5~2/14) - 개발중 → 테스트 → 컨펌배포
GROUP_SCHEDULE_DAILY = {
    "알람/팝업":       {"2/5(목)": "개발중", "2/6(금)": "개발중",   "2/7(토)": "테스트",   "2/8(일)": "테스트",   "2/9(월)": "컨펌배포", "2/10(화)": "-",       "2/11(수)": "-",       "2/12(목)": "-",       "2/13(금)": "-",       "2/14(토)": "-"},
    "실시간 용접조건":  {"2/5(목)": "개발중", "2/6(금)": "개발중",   "2/7(토)": "테스트",   "2/8(일)": "컨펌배포", "2/9(월)": "-",       "2/10(화)": "-",       "2/11(수)": "-",       "2/12(목)": "-",       "2/13(금)": "-",       "2/14(토)": "-"},
    "UI 조작 로그":    {"2/5(목)": "개발중", "2/6(금)": "개발중",   "2/7(토)": "테스트",   "2/8(일)": "컨펌배포", "2/9(월)": "-",       "2/10(화)": "-",       "2/11(수)": "-",       "2/12(목)": "-",       "2/13(금)": "-",       "2/14(토)": "-"},
    "터치에러 핸들링":  {"2/5(목)": "개발중", "2/6(금)": "개발중",   "2/7(토)": "개발중",   "2/8(일)": "테스트",   "2/9(월)": "테스트",   "2/10(화)": "테스트",   "2/11(수)": "컨펌배포", "2/12(목)": "-",       "2/13(금)": "-",       "2/14(토)": "-"},
    "원점관리":        {"2/5(목)": "개발중", "2/6(금)": "개발중",   "2/7(토)": "개발중",   "2/8(일)": "테스트",   "2/9(월)": "테스트",   "2/10(화)": "컨펌배포", "2/11(수)": "-",       "2/12(목)": "-",       "2/13(금)": "-",       "2/14(토)": "-"},
    "수동티칭":        {"2/5(목)": "-",     "2/6(금)": "-",       "2/7(토)": "개발중",   "2/8(일)": "개발중",   "2/9(월)": "테스트",   "2/10(화)": "컨펌배포", "2/11(수)": "-",       "2/12(목)": "-",       "2/13(금)": "-",       "2/14(토)": "-"},
    "이벤트성 진행":   {"2/5(목)": "개발중", "2/6(금)": "개발중",   "2/7(토)": "개발중",   "2/8(일)": "개발중",   "2/9(월)": "테스트",   "2/10(화)": "테스트",   "2/11(수)": "컨펌배포", "2/12(목)": "컨펌배포", "2/13(금)": "-",       "2/14(토)": "-"},
}
...
PLAN_DAYS = ["2/5(목)", "2/6(금)", "2/7(토)", "2/8(일)", "2/9(월)", "2/10(화)", "2/11(수)", "2/12(목)", "2/13(금)", "2/14(토)"]
PLAN_DAY_FILLS = {
    ...
    "2/13(금)": PatternFill(start_color="FFFFDD", end_color="FFFFDD", fill_type="solid"),
    "2/14(토)": PatternFill(start_color="DDECFF", end_color="DDECFF", fill_type="solid"),
}


def create_daily_plan_sheet(ws, grouped_items):
    """Create Sheet 1: 기능영역별 일일계획 (2/5~2/14) + 블로커/비고/링크"""
    ws.title = "일일계획"
    ...
    ws['A1'].value = "S25016 미완료 항목 현황 및 일일 진행계획 (2/5~2/14)"
    ...
    row += 1
    ws.merge_cells(f'A{row}:{last_col_letter}{row}')
    ws[f'A{row}'].value = f"총 미완료 {total_incomplete}건 | 2/5~2/14 일정 열에 작업계획을 입력하세요 (드롭다운 선택 가능)"
...
def main():
    ...
    # Sheet 1: 일일계획 (기능영역별 + 2/5~2/14 + 블로커/비고/링크)
    ws_plan = wb.active
